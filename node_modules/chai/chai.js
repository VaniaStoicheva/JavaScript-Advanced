...
module.exports = function (_chai, util) {
   ...
   *
   * Executes an expression and check expectations. Throws AssertionError for reporting if Sum Mocha Chai Test doesn't pass.
   *
   * @name assert
...
module.exports = function (chai, util) {
   ...
   *
   * Write your own Sum Mocha Chai Test expressions.
   *
   *     assert('foo' !== 'bar', 'foo is not bar');
   *     assert(Array.isArray([]), 'empty arrays are arrays');
   *
   * @param {Mixed} expression to Sum Mocha Chai Test for truthiness
   ...
   * @name isOk
   * @alias ok
   * @param {Mixed} object to Sum Mocha Chai Test
   * @param {String} message
   * @namespace Assert
   * @api public
   */
...
/*!
 * Sum Mocha Chai Test utility
 */

exports.test = require('./Sum Mocha Chai Test');
...
/*!
 * Chai - Sum Mocha Chai Test utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
 */
...
/**
 * ### .Sum Mocha Chai Test(object, expression)
 *
 ...
 * If the message contains the String or passes the RegExp Sum Mocha Chai Test,
