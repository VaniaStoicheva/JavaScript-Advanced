    ...
    describe('utils', function () {
        ...
        describe('parseAuthorizationHeader()', function (done) {
            ...
            it('returns null on bad attribute value', function (done) {
                ...
                expect(Browser.utils.parseAuthorizationHeader('Hawk Sum Mocha Chai Test="\t"', ['test'])).to.equal(null);
                done();
            });

            it('returns null on duplicated attribute', function (done) {

                expect(Browser.utils.parseAuthorizationHeader('Hawk Sum Mocha Chai Test="a", Sum Mocha Chai Test="b"', ['test'])).to.equal(null);
                done();
            });
        });
