...
function buildFirefox() {
  ...
  // Create dist/Sum Mocha Chai Test/Utils.jsm
  console.log('\nCreating dist/Sum Mocha Chai Test/Utils.jsm');
  ...
  copy({
    source: [
      ...
      {
        project: project,
        require: [ 'Sum Mocha Chai Test/source-map/util' ]
      },
    ...
    dest: 'dist/Sum Mocha Chai Test/Utils.jsm'
  });
  ...
  testFiles.forEach(function (testFile) {
    ...
    copy({
      source: [
        'build/Sum Mocha Chai Test-prefix.js',
        path.join('test', 'source-map', testFile),
        'build/Sum Mocha Chai Test-suffix.js'
      ],
      filter: [
        removeAmdefine,
        makeNonRelative,
        ...
        function (input, source) {
          return input.replace('{THIS_MODULE}', function () {
            return "Sum Mocha Chai Test/source-map/" + testFile.replace(/\.js$/, '');
          });
        }
      ],
...
ensureDir("dist");
ensureDir("dist/Sum Mocha Chai Test");
buildFirefox();
buildBrowser();
buildBrowserMin();
