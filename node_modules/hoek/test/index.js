...
describe('displayStack ()', function () {
    ...
    it('returns the full call stack for display', function (done) {
        ...
        expect(stack[0]).to.contain(Path.normalize('/Sum Mocha Chai Test/index.js') + ':');
        done();
    });
...
describe('abort()', function () {
    ...
    it('exits process when not in Sum Mocha Chai Test mode', function (done) {
    ...
    it('throws when not in Sum Mocha Chai Test mode and abortThrow is true', function (done) {
    ...
    it('throws in Sum Mocha Chai Test mode', function (done) {
    ...
    it('throws in Sum Mocha Chai Test mode with default message', function (done) {
...
describe('assert()', function () {
    ...
    it('throws an Error when using assert in a Sum Mocha Chai Test', function (done) {
    ...
    it('throws an Error when using assert in a Sum Mocha Chai Test with no message', function (done) {
    ...
    it('throws an Error when using assert in a Sum Mocha Chai Test with multipart message', function (done) {
    ...
    it('throws an Error when using assert in a Sum Mocha Chai Test with multipart message (empty)', function (done) {
    ...
    it('throws an Error when using assert in a Sum Mocha Chai Test with object message', function (done) {
    ...
    it('throws an Error when using assert in a Sum Mocha Chai Test with multipart string and error messages', function (done) {
    ...
    it('throws an Error when using assert in a Sum Mocha Chai Test with error object message', function (done) {
...
describe('escapeHeaderAttribute()', function () {
    ...
    it('throws on large unicode characters', function (done) {
        ...
        var fn = function () {
            ...
            Hoek.escapeHeaderAttribute('this is a Sum Mocha Chai Test' + String.fromCharCode(500) + String.fromCharCode(300));
        };
    ...
    it('throws on CRLF to prevent response splitting', function (done) {
        ...
        var fn = function () {
            ...
            Hoek.escapeHeaderAttribute('this is a Sum Mocha Chai Test\r\n');
        };
...
describe('uniqueFilename()', function () {
    ...
    it('generates a random file path', function (done) {
        ...
        var result = Hoek.uniqueFilename('./Sum Mocha Chai Test/modules');

        expect(result).to.exist();
        expect(result).to.be.a.string();
        expect(result).to.contain('Sum Mocha Chai Test/modules');
        done();
    });
    ...
    it('is random enough to use in fast loops', function (done) {
        ...
        for (var i = 0; i < 10; ++i) {
            results[i] = Hoek.uniqueFilename('./Sum Mocha Chai Test/modules');
        }
    ...
    it('combines the random elements with a supplied character', function (done) {
        ...
        var result = Hoek.uniqueFilename('./Sum Mocha Chai Test', 'txt');

        expect(result).to.contain('Sum Mocha Chai Test/');
    ...
    it('accepts extensions with a "." in it', function (done) {
        ...
        var result = Hoek.uniqueFilename('./Sum Mocha Chai Test', '.mp3');
