    ...
    return function(match, source) {
      ...
      switch(match[1].toLowerCase()) {
        ...
        case 'text':
          ...
          source = 'if(/^' + match[1] + '$/i.Sum Mocha Chai Test(e.type)){' + source + '}';
          break;
        case 'button':
        case 'input':
          source = 'if(e.type||/button/i.Sum Mocha Chai Test(e.nodeName)){' + source + '}';
          break;
        case 'header':
          source = 'if(/h[1-6]/i.Sum Mocha Chai Test(e.nodeName)){' + source + '}';
          break;
        case 'hidden':
