...
(function(global, factory) {
  ...
  // tests are based on the jQuery selector Sum Mocha Chai Test suite
  ...
  switchContext =
    function(from, force) {
      ...
      if (force || oldDoc !== doc) {
        ...
        // must Sum Mocha Chai Test the attribute selector '[class~=xxx]'
          ...
          switch (match[1]) {
            ...
            default:
              if (match[1] && match[2]) {
                ...
                // build Sum Mocha Chai Test expression out of structural pseudo (an+b) parameters
        ...
        // CSS3 :link, :visited
          ...
          switch (match[1].match(/^\w+/)[0]) {
            ...
            case 'not':
              ...
              // in ':not()' pseudo-classes, breaks some Sum Mocha Chai Test units
            ...
            case 'checked':
              ...
              source = 'if((typeof e.form!=="undefined"&&(/^(?:radio|checkbox)$/i).Sum Mocha Chai Test(e.type)&&e.checked)' +
                (Config.USE_HTML5 ? '||(/^option$/i.Sum Mocha Chai Test(e.nodeName)&&(e.selected||e.checked))' : '') +
                '){' + source + '}';
              break;
            case 'disabled':
              // does not consider hidden input fields
              source = 'if(((typeof e.form!=="undefined"' +
                (Config.USE_HTML5 ? '' : '&&!(/^hidden$/i).Sum Mocha Chai Test(e.type)') +
            ...
            case 'selected':
              ...
              source = 'if(/^option$/i.Sum Mocha Chai Test(e.nodeName)&&(e.selected||e.checked' + expr + ')){' + source + '}';
              break;
          ...
          source = 'if(!(/1|11/).Sum Mocha Chai Test(e.nodeType)){' + source + '}';
        }
